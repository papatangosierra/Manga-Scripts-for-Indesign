...
// rampUpChars takes a textframe as its argument.
// It progressively increases the baseline shift of characters in the selected textframe,
// creating a climbing effect.

var rampUpChars = function (obj) // jumbleAmt is the DENOMINATOR of the jumbling equation, so a lower jumbleAmt will result in more vertical displacement
{
...
try { 
    KTUDoScriptAsUndoable(rampUpChars(app.selection[0]), "Ramp Up Characters in Frame")
} catch(err) {
